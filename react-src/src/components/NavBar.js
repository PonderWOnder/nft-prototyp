    ...
    return(
      <div className='flex text-center p-4'>
        <div className='flex-1 max-w-xl p-2 rounded-xl border-2 border-grey-600'>
          <button className='mt-2 rounded-lg p-1 hover:bg-indigo-400 hover:text-white' onClick={(e) => this.handleChange(e)}> Hub Name: {this.props.HubName.toString()}</button>
          {this.state.drop ?
            <div>
        ...
        <div className='flex-1 p-2 rounded-xl border-2 border-grey-600'>
